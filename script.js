...
const geonamesCache = {
    ...
    'Curitiba': { lat: -24.3284, lng: -49.2733 },
    ...
    'João Pessoa': { lat: -8.5496, lng: -34.8450 },
    ...
    'Campo Grande': { lat: -22.4697, lng: -54.6201 },
    ...
    'Caxias do Sul': { lat: -28.1767, lng: -51.1800 },
...
async function plotarPings(data, geojson) {
    ...
    for (const cidade of cidadesUnicas) {
        ...
        if (coords) {
            ...
            svg.setAttribute('style', `left: calc(${x}px - 4.5px + 22px); top: calc(${y}px - 4.5px + 18px);`);
